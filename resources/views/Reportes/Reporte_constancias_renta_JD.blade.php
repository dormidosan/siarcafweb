...
<div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">Reporte constancias de renta JD</h3>
        </div>
        <div class="box-body">
        ...
        <div class="box-body">
                  <table class="table table-hover">
                    ...
                    <tr>                                     
                      ...
                      <td><a href="{{url("/Reporte_constancias_renta_JD/1")}}" class="btn btn-block btn-success btn-xs" >VER</a></td>
                      <td><a href="{{url("/Reporte_constancias_renta_JD/2")}}" class="btn btn-block btn-success btn-xs" >DESCARGAR</a></td>
