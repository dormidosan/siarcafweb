...
<div class="box box-solid box-default">
    ...
    <div class="box-body table-responsive">
        <table id="listadoComisiones" class="table table-striped table-bordered table-condensed table-hover dataTable text-center">
            ...
            <tbody id="cuerpoTabla">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="estado" class="toogle" data-size="mini" onchange="cambiar_estado_comision({{ $comision->id }})" checked>
                        </i>
                        @else
                        <input type="checkbox" name="estado" class="toogle" data-size="mini" onchange="cambiar_estado_comision({{ $comision->id }})">
                        </i>
                        @endif @endif
                    </td>
