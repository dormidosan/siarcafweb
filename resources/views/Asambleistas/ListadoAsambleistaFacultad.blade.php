...
<div class="box box-danger ">
    ...
    <div class="box-body">
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            @foreach($facultades as $facultad) @php $i = 1 @endphp
            <div class="panel panel-default">
                ...
                <div id="collapse{{$facultad->id}}" class="panel-collapse collapse " role="tabpanel" aria-labelledby="heading{{$facultad->id}}">
                                   ...
                                   <tr>
                                      ...
                                      <td>
                                         <div class="center-block">
                                            <img src="{!!$fotos!!}{!!$asambleista->user->persona->foto!!}" class="img-responsives" width="70px" style="margin-left: 25px !important; " alt="User Image">
                                         </div>
                                      </td>
